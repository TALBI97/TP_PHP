    ...
    <div class="container">
        ...
        <form method="POST"  enctype="multipart/form-data" class="p-5">
            <div class="form-group">
                ...
                <input type="text" name="product-name" class="form-control " value="<?php echo $produit->id?>" disabled >
            </div>
            <div class="form-group">
                <label>Nouveau nom du produit</label>
            ...
            <div class="form-group">
                <label>Nouvelle Photo du produit</label>
            ...
            <button name="btn-modifier" type="submit" class="btn btn-primary">Modifier le produit</button>
        </form>
    </div>
